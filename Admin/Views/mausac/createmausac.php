            ...
            <article>
                ...
                <form action="?act=postcreateMausanpham" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" style="margin-top: 20px;">
                        <label for="exampleInputEmail1" class="form-label">Nhập tên màu</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tenmau">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Chọn ảnh màu</label>
                        <input type="file" class="form-control" id="exampleInputPassword1" name="anhmau" style="height: 45px;">
                    </div>
