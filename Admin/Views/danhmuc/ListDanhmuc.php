    ...
    <section class="Danhmuc">
        ...
        <section class="contenDanhmuc">
            ...
            <div class="button" style="display: flex; margin-bottom: 30px;">
                ...
                <a style="margin-top: 20px; margin-left: 600px;" href="?act=createDanhmuc"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Thêm mới</button></a>
            </div>
            <article>
